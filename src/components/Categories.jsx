...
const categories = () =>{
    ...
    return( 
        <>
        <div className=" d-flex align-items-center flex-row " style={{backgroundColor:"white",justifyContent:"space-between",width:"100%",paddingTop:"100px", paddingLeft:"50px",paddingRight:"50px"}}>
        ...
        <div className="categories  d-flex align-items-center" style={{width:"100vw"}}>
